...
public class VeloRangeSeekBar<T extends Number> extends ImageView {
    /**
     * Default color of a {@link VeloRangeSeekBar}, #FF33B5E5. This is also known as "Ice Cream Sandwich" blue.
     */
    ...
    public static Integer DEFAULT_CRITICAL = 10;
    ...
    public VeloRangeSeekBar(Context context) {
        super(context);
        init(context, null);
    }

    public VeloRangeSeekBar(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    public VeloRangeSeekBar(Context context, AttributeSet attrs, int defStyle) {
...
//        }
    ...
    public interface OnRangeSeekBarChangeListener<T> {
        ...
        void onRangeSeekBarValuesChanged(VeloRangeSeekBar<?> bar, T warnValue, T critValue);
    }
